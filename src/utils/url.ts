...
export const POST_URL_ALL: string = `${POST_BASE_URL}?page=1&pagesize=80&fromdate=%s&todate=%s&order=desc&sort=activity&site=stackoverflow`

export const COMMENTS_URL_BY_POST = `${POST_BASE_URL}/%s/comments?page=1&pagesize=80&fromdate=%s&todate=%s&order=desc&sort=creation&site=stackoverflow`
